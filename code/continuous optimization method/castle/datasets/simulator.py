...
class DAG(object):
    ...
    @staticmethod
    def erdos_renyi(dataset, n_nodes, n_edges, seed, weight_range=None):
        ...
        if weight_range is None:
            ...
            G, G_true, WG_true = DAG._BtoW(dataset, B, n_nodes, weight_range)
        return G, G_true, WG_true
...
class IIDSimulation(object):
    ...
    def __init__(self, n, W, method='linear', 
