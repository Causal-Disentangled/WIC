...
class MaskedModel(torch.nn.Module):
    ...
    def __init__(self, model_type, n_samples, n_nodes, pns_mask, num_hidden_layers,
                 hidden_dim, l1_graph_penalty, seed, CI_table, device,args) -> None:
    ...
    def forward(self, x, rho, alpha, temperature) -> tuple:
        ...
        CI_loss = CI_test_Loss(self.w.clone().detach(), self.CI_table)
    ...
    def _preprocess_graph(self, w, tau, seed) -> torch.Tensor:
