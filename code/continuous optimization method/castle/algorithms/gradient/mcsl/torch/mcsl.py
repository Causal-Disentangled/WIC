...
class MCSL(BaseLearner):
    ...
    def __init__(self, model_type, num_hidden_layers, hidden_dim,
                 graph_thresh, l1_graph_penalty, learning_rate,
                 max_iter, iter_step, init_iter, h_tol,
                 init_rho, rho_thresh, h_thresh,
                 rho_multiply, temperature, device_type,
                 device_ids, random_seed, CI_table,args) -> None:
