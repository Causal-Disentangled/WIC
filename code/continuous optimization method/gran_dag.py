...
dataset = IIDSimulation(n, W=WG_true, method='nonlinear',
                        sem_type='mlp')
...
gnd = GraNDAG(input_dim=x.shape[1],CI_table=CI_table,hard_constraint=hard_constraint,hidden_num=2,
                 hidden_dim=10,
                 batch_size=100,
                 lr=0.01,
                 iterations=10000,model_name='NonLinGaussANM',
