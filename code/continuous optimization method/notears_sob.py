...
how to use NotearsNonlinear algorithm in `castle` package for causal inference.
...
parser.add_argument('--CI_order', type=int, default=1,
...
nt = NotearsNonlinear(CI_table=CI_table, lambda1=0.04,
                 lambda2=0.04,
                 max_iter=2000,
                 h_tol=1e-16,
                 rho_max=1e+16,
...
# calculate accuracy
met = MetricsDAG(nt.causal_matrix, dag)
print(met.metrics)
