...
parser.add_argument('--data_dir', type=str, default= 'data/',
                    help='data file name containing the discrete files.')
parser.add_argument('--data_sample_size', type=int, default=1100,
...
parser.add_argument('--lambda_CI',  type = float, default= 0.5, #0.5 is best real 0.25 is best syn
...
parser.add_argument('--lr', type=float, default=3e-3,  # baseline rate = 1e-3 syn = 3e-3
                    help='Initial learning rate.')
parser.add_argument('--encoder-hidden', type=int, default=64,#64 syn
                    help='Number of hidden units.')
parser.add_argument('--decoder-hidden', type=int, default=64,#64 syn
                    help='Number of hidden units.')
...
try:
    ...
    print(nx.DiGraph(best_ELBO_graph))
