...
parser.add_argument('--set_errors',  type = int, default=3,
...
parser.add_argument('--encoder-hidden', type=int, default=94,
                    help='Number of hidden units.')
parser.add_argument('--decoder-hidden', type=int, default=94,
                    help='Number of hidden units.')
